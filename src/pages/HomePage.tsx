            ...
            {[
              ...
              <div key={index} className="flex items-center">
                <div className="flex flex-col items-center text-center px-1 sm:px-3 md:px-6">
                  ...
                  <h3 className="font-semibold text-foreground text-[10px] sm:text-sm md:text-base">{item.title}</h3>
                  <p className="text-muted-foreground text-[8px] sm:text-xs md:text-sm max-w-[60px] sm:max-w-[110px] md:max-w-[140px]">{item.description}</p>
                </div>
                {index < 3 && (
