    ...
    <div>
      ...
      <section className="relative min-h-[400px] md:min-h-[450px] flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              <pattern id="largeGrid" width="100" height="100" patternUnits="userSpaceOnUse">
                ...
                <path d="M 100 0 L 0 0 0 100" fill="none" stroke="rgba(255,255,255,0.10)" strokeWidth="1"/>
              </pattern>
            </defs>
          ...
          <svg className="absolute top-12 left-1/4 w-48 h-8 text-white/[0.15]" viewBox="0 0 200 30">
          ...
          <svg className="absolute top-1/4 right-8 w-8 h-32 text-white/[0.12]" viewBox="0 0 30 120">
          ...
          <svg className="absolute bottom-16 right-1/4 w-24 h-24 text-white/[0.12]" viewBox="0 0 100 100">
          ...
          <svg className="absolute bottom-1/3 left-1/4 w-20 h-20 text-white/[0.10]" viewBox="0 0 100 100">
          ...
          <svg className="absolute -top-20 -right-20 w-80 h-80 text-white/[0.12]" viewBox="0 0 100 100" fill="currentColor">
          ...
          <svg className="absolute -bottom-16 -left-16 w-56 h-56 text-white/[0.10]" viewBox="0 0 100 100" fill="currentColor">
          ...
          <svg className="absolute top-1/3 left-10 w-32 h-32 text-white/[0.08]" viewBox="0 0 100 100" fill="currentColor">
          ...
          <svg className="absolute top-8 left-1/3 w-20 h-20 text-white/[0.10]" viewBox="0 0 100 100" fill="currentColor">
