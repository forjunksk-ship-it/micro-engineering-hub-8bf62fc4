...
const HomePage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative min-h-[400px] md:min-h-[450px] lg:min-h-[520px] flex items-center">
        ...
        <div className="relative z-10 container-custom py-6 md:py-10 lg:py-14">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
            ...
            <div className="w-full md:w-2/5 lg:w-[45%] flex-shrink-0 animate-slide-up">
                <div 
